  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/returns" element={<Guard can={(u) => canView(u, "sales")}><Returns /></Guard>} />
        ...
        <Route path="/timemachine" element={<Guard can={(u) => canView(u, "product")}><TimeMachine /></Guard>} />
        <Route
          path="/partners"
        ...
        <Route path="/settings/company" element={<Guard can={(u) => u.is_system_admin}><CompanySettings /></Guard>} />
