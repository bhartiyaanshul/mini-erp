...
export const NAV: NavItem[] = [
  ...
  { to: "/returns", label: "Returns", icon: RotateCcw, visible: (u) => canView(u, "sales") },
  ...
  { to: "/timemachine", label: "Time Machine", icon: History, visible: (u) => canView(u, "product") },
  ...
  { to: "/settings/company", label: "Company Branding", icon: Building2, visible: (u) => u.is_system_admin },
